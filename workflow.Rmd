...
This step takes a little bit of time, so we've cached the results in `data/path_detail.rds`. Make `eval=TRUE` to run it
...
(Full list of options.)` <- "Frame_Shift_Del; Frame_Shift_Ins; In_Frame_Del; In_Frame_Ins; Missense_Mutation; Nonsense_Mutation; Nonstop_Mutation; Splice_Site"
